...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-maroon-400 to-maroon-500 px-8 py-8 text-center">
            ...
            <p class="text-maroon-100 text-sm mt-1">Sign in to your Tunda account</p>
        </div>
        ...
        <div class="p-8">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}
                            class="w-4 h-4 rounded border-gray-300 text-maroon-400 focus:ring-maroon-400">
                        <span class="text-sm text-gray-600">Remember me</span>
                    </label>
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm font-medium text-maroon-400 hover:text-maroon-500 transition-colors">Forgot password?</a>
                    @endif
                </div>
            ...
            @if (Route::has('register'))
                ...
                <p class="text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('register') }}" class="font-semibold text-maroon-400 hover:text-maroon-500 transition-colors">Create one</a>
                </p>
            @endif
        </div>
    </div>
