...
class CallController extends Controller
{
    ...
    {
        $request->validate([
            'status' => 'required|in:accepted,declined,missed,completed',
        ...
        $call->update([
            ...
            'duration' => $request->duration ?? $call->duration,
            'ended_at' => in_array($request->status, ['completed', 'declined', 'missed']) ? now() : $call->ended_at,
        ]);
